        ...
        public void actionPerformed(ActionEvent event)
        {
            if (event.getSource() == fillButton)
            {
                switch(tool)
                {
                    case RECTANGLE:
                    {
                        SelecionMateria.paint.drawPanel.tool.setStrokeStyle(StrokeStyle.FILL_RECT);
                        break;
                    }
                    case ROUND_RECT:
                    {
                        SelecionMateria.paint.drawPanel.tool.setStrokeStyle(StrokeStyle.FILL_ROUND_RECT);
                        break;
                    }
                    case OVAL:
                    {
                        SelecionMateria.paint.drawPanel.tool.setStrokeStyle(StrokeStyle.FILL_OVAL);
                        break;
                    }
                }
            }
               ...
               switch(tool)
                {
                    case RECTANGLE:
                    {
                        SelecionMateria.paint.drawPanel.tool.setStrokeStyle(StrokeStyle.OPEN_RECT);
                        break;
                    }
                    case ROUND_RECT:
                    {
                        SelecionMateria.paint.drawPanel.tool.setStrokeStyle(StrokeStyle.OPEN_ROUND_RECT);
                        break;
                    }
                    case OVAL:
                    {
                        SelecionMateria.paint.drawPanel.tool.setStrokeStyle(StrokeStyle.OPEN_OVAL);
                        break;
                    }
                }
            }
